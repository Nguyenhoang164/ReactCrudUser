...
function Category(){
    ...
    const deleteCategory = (id) =>{
      axios.delete("http://localhost:8080/api/category/delete/" + id +"/"+userForm.values.nameUser+"/"+ userForm.values.password).then(res =>{
        axios.get("http://localhost:8080/api/category").then(res =>{
               setCategory(res.data);
        });
      });
      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            ...
            <Link to={'/category?email=' + userForm.values.email}><button class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page" >Category</button></Link> 
            ...
            <Link to ={'/createCategory?email='+userForm.values.email} class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium"><button>Create Category</button></Link>
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="/create" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Category</a>
                ...
                {categorys.map(item => (
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 text-right">
                     <Link to={'/updateCategory?email=' + email +'&id=' + item.id}><button>Update</button></Link> 
