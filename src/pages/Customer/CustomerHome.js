...
useEffect(() => {
  setIsLoading(true);
  axios.get("http://localhost:8080/api/customer/getAllCustomer")
    .then(response => {
    ...
    <div class="md:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <Link to={"/customer?email=" + email} class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page" ><button>Customer</button></Link>
